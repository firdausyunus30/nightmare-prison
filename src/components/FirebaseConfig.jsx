      ...
      <div className="w-full max-w-md p-6 rounded-2xl glass-panel metal-border border-red-900/30 box-glow-red">
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-gray-400 mt-2">
            Nightmare Prison uses Firebase Realtime Database to sync player states in real-time. Please configure your settings below.
          </p>
        </div>
        ...
        {success ? (
          <div className="text-center py-8">
            <div className="text-prison-safe text-lg font-semibold mb-2">✓ Connection Established</div>
            <p className="text-gray-400 text-xs">Entering the prison yard...</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="AIzaSy..."
                className="w-full bg-prison-dark border border-prison-iron focus:border-red-600 focus:ring-1 focus:ring-red-600 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 outline-none transition-all duration-300"
                required
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="my-prison-game-123"
                className="w-full bg-prison-dark border border-prison-iron focus:border-red-600 focus:ring-1 focus:ring-red-600 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 outline-none transition-all duration-300"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full mt-2 py-3 rounded-lg bg-prison-blood hover:bg-prison-danger border border-red-500/20 text-white font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 group hover:shadow-[0_0_15px_rgba(220,38,38,0.4)] active:scale-95"
            >
        ...
        <div className="mt-6 border-t border-prison-iron/40 pt-4 text-center">
          <a
