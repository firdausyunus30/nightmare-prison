  ...
  return (
    <div className="flex flex-col justify-between min-h-screen px-4 py-8">
      ...
      <div className="w-full max-w-md mx-auto text-center">
        <p className="text-xs uppercase tracking-widest text-gray-500">The Moon Rises</p>
        <div className="text-3xl font-black text-white font-mono mt-1 text-glow-red animate-pulse">
          {timeLeft}s
        </div>
        <p className="text-[10px] text-gray-600 uppercase tracking-widest mt-1">Memorize your role before night falls</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center py-6 w-full max-w-sm mx-auto">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-full flex items-center justify-between opacity-50 border-b border-moon-iron/40 pb-2">
                <span className="text-[9px] font-mono text-gray-500">SEALED</span>
              ...
              <div className="flex flex-col items-center justify-center my-auto text-center space-y-4">
                {/* Moon / sealed role icon */}
                <div className="relative flex items-center justify-center w-20 h-20 rounded-full border-2 border-moon-iron bg-moon-dark">
      ...
      <div className="w-full max-w-sm mx-auto text-center">
        {!isFlipped ? (
          ...
          <p className="text-xs text-moon-safe flex items-center justify-center gap-1.5 font-semibold">
