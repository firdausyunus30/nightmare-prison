...
import { 
  Moon, Sun, Vote, Send, Skull, Shield, Eye, MessageSquare, 
  Check, Lock, ShieldAlert, Sparkles, Zap, ChevronRight, HelpCircle 
} from 'lucide-react';
            ...
            <div className="flex-1 p-3 overflow-y-auto space-y-2 min-h-0">
              {chatMessages.length === 0 ? (
                ...
                chatMessages.map((msg, i) => {
                  ...
                  const senderRole = players[msg.senderId]?.role;
